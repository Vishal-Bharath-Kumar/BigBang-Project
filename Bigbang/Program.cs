...
builder.Services.AddDbContext<BigbangDbContext>(options => options.UseSqlServer(connectionstring));
#endregion
builder.Services.AddScoped<IBooking_Services, Booking_Services>();
builder.Services.AddScoped<IHotels_Services, Hotels_Services>();
builder.Services.AddScoped<ILogIn_Services, LogIn_Services>();
